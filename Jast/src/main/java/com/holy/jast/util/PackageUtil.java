...
public class PackageUtil {
    public static void main(String[] args) throws Exception {
        String packageName = "com.mogu.np.controller";
        // List<String> classNames = getClassName(packageName);
        Set<Class<?>> classNames = getClasses(packageName, Api.class);
        for(Class cn:classNames){
    ...
    public static void findAndAddClassesInPackageByFile(String packageName,
                                                        String packagePath, final boolean recursive, Set<Class<?>> classes,Class<? extends  Annotation> annotation) {
        // 获取此包的目录 建立一个File
